def VerticalWebonLBHD_SectionModulus(S_m, fy):
    ...
    print
def VerticalWebonLBHD_SectionArea(S_m, fy):
...
VerticalWebonLBHD_SectionModulus(S_m, fy)

# S_m = 1.0
# fy = 23500.
VerticalWebonLBHD_SectionArea(S_m, fy)
